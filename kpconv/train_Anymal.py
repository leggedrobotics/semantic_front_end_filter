...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = AnymalDataset(config, train=True)
    test_dataset = AnymalDataset(config, train=False)

    # Initialize samplers
    training_sampler = AnymalSampler(training_dataset, balance_labels=True)
    test_sampler = AnymalSampler(test_dataset, balance_labels=True)
