...
if __name__ == "__main__":
    ...
    # Build model
    model_path = "/home/anqiao/catkin_ws/SA_dataset/mountpoint/Models/2022-09-17-00-52-47-10_3_0/UnetAdaptiveBins_latest.pt"
    ...
    for num, sample in enumerate(samples):
        ...
        traj_mask = ~np.isnan(pred) & (semantic_bitmap==1) & (data["depth_var"][0]>0) & (data["depth_var"][1]<0.05) & (data['pc_image'].squeeze()>1e-9) # &  (data['pc_image'].squeeze()<10) & (data["depth_var"][0].squeeze()<10) & (data['pc_image'].squeeze()>1e-9)     
