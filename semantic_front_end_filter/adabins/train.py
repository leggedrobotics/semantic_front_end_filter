...
def train(model, args, epochs=10, experiment_name="DeepLab", lr=0.0001, root=".", device=None,
    ...
    for epoch in range(args.epoch, epochs):
        ...
        if (epoch+1)%2==0:
            log_images(test_loader, model, "vis/test", step_count, use_adabins=args.modelconfig.use_adabins, pred_horzline=args.modelconfig.pred_horzline)
            log_images(train_loader, model, "vis/train", step_count, use_adabins=args.modelconfig.use_adabins, pred_horzline=args.modelconfig.pred_horzline)
    return model
