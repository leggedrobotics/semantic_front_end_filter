...
class TrainConfig:
    ...
    testing: list = field(default_factory=lambda: [ "Reconstruct_2022-07-19-18-16-39_0", # Perugia hillside
                                                    "Reconstruct_2022-07-19-19-02-15_0", # Perugia forest
                                                    "Reconstruct_2022-07-18-20-34-01_0", # Perugia grassland
                                                    ]) 
    training: list = field(default_factory=lambda: ["Reconstruct_2022-07-19-20-46-08_0", # Perugia hillside
